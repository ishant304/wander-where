...
function Explore() {
  ...
  return (
    <div className="w-screen h-[calc(100vh-121px)] relative">
      <div className="absolute top-4 right-4 z-10 pointer-events-none">
        <div className="rounded-md bg-white/80 border border-teal-700 px-3 py-1 text-sm text-teal-600 shadow-md backdrop-blur-sm">
          Zoom to explore each area
        </div>
      </div>
      <MapContainer
